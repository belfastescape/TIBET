...
function ShareCard({ delay = 0 }: { delay?: number }) {
  ...
  const handleShare = async () => {
    ...
    gtagEvent({ action: "share", category: "Game Page", label: "share diamond page", value: 1 })
    if (navigator.share) {
      try {
        await navigator.share({
          title: "The Billion Dollar Heist – Escape Rooms Tibet",
          text: "Check out The Billion Dollar Heist at Escape Rooms Tibet — steal a priceless diamond through a laser maze!",
